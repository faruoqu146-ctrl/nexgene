...
def test_v090_contract():
    ...
    assert 'APP_VERSION = "0.9.0"' in main
    ...
    assert '/api/v1/patterns' in main and '/api/v1/insights' in main and '/api/v1/signals' in main
    ...
    assert 'APP_VERSION' in readme and 'v0.9.0' in readme and 'NexGene Signals' in readme
